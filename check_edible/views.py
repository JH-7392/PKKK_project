...
def result(request):
    ...
    cat = [
        ...
        '브로콜리는 항암 효과가 뛰어나며, 비타민 C가 레몬의 두 배 이상 함유되어 있어 감기 예방과 면역력 증가에도 도움이 된다. 또한, 칼슘도 풍부해 골다공증 및 심장병 예방에도 도움이 되는 거으로 알렺 있다. ', 
        ...
        '강아지와 마찬가지로 고양이도 포도에 중독 증상을 나타낸 보고가 있으므로 주의해야 한다. 특히 위험한 것이 급성 신부정 증상이다. 급성 신부전은 신장이 제대로 작동하지 않아 사망까지 다다를 수 있는 무서운 질병이므로 포도를 급여하는 것은 아주 위험한 일이다.', 
        '고양이는 귤 껍질에 함유된 리모넨이라는 물질을 분해하지 못한다. 과육, 과즙만 주는 것은 괜찮지만 주의해야 한다. 또한, 껍질의 즙이 닿으면 피부 염증을 일으키는 경우도 있으므로 주의가 필요하다.', 
        '참외에는 비타민 C가 풍부하게 함유되어 있어 피로회복에 도움이 되며, 과육의 수분 함량도 90% 이상이어서 섭취시 수분 보충에 많은 도움이 된다. 단, 참외 씨는 소화가 잘 되지 않거나 배탈을 유발할 수 있으므로 반드시 제거하고 과육만 적당한 크기로 썰어서 주거나 고양이 전용 우유와 함께 믹서기에 넣고 갈아서 주어도 된다.', 
